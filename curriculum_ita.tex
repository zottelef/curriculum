...
\begin{document}
  \header{Fabio}{Zottele} {tecnologo sperimentatore di quarto livello}
    ...
    \begin{entrylist}
    \entry
        {2000}{Repubblica Italiana}{Commissariato del Governo per la Priovincia di Bolzano}{\emph{"patentino di bilinguismo (Diploma di istituto di istruzione secondaria di primo grado)"}}
    \end{entrylist}
    ...
    \begin{refsection}
        ...
        \printbibliography[type=article, title={\textit{peer reviewed}}, heading=subbibliography, notkeyword=divulgative]
    \end{refsection}
